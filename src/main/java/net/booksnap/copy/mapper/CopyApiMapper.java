package net.booksnap.copy.mapper;
...
public abstract class CopyApiMapper {
    ...
    protected LibraryDTO mapLibrary(net.booksnap.library.Library library) {
        if (library == null) {
            return null;
        }
    ...
    protected BookDTO mapBook(net.booksnap.book.Book book) {
        if (book == null) {
            return null;
        }
